...
export default class CityManagerPage extends Component {
        ...
        <View style={{
          ...
          <View style={{
            ...
            <View style={{}}>
              ...
              }}>{cityItem.country + ' ' + cityName}</Text>
            </View>
            {/* <View>
                        <View style={{
                            flexDirection: 'row',
      ...
      const child0 = (
        <View style={{padding: 4, marginEnd: 12}}>
          <Text style={{
            color: 'white',
            fontSize: 14,
          }}>{hasAllSelected ? 'DeselectAll' : 'SelectAll'}</Text>
        </View>
      );
      const child1 = (
        <View style={{padding: 4, marginEnd: 12}}>
    ...
    refreshHeaderTitle = () => {
      const selectedItems = this.selectedItems;
      this.props.navigation.setParams({
        headerTitle: selectedItems.length === 0 ? 'Select' : 'Select' + selectedItems.length,
      });
    };
